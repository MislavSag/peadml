...
# SETUP -------------------------------------------------------------------
# Paths
PATH                  = "/home/sn/data/strategies/pead"
...
target_variables = colnames(dataset)[grepl("^ret_|bin_", colnames(dataset))]
...
# scp -r padobran:/home/jmaric/peadml/predictors_padobran/ /home/sn/data/strategies/pead/
